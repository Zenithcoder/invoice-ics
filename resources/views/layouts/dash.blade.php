            ...
            <div class="topbar-left">
                <a href="index.html" class="logo">
                    <span class="logo-light">
                            <i class="mdi mdi-camera-control"></i> Invoice
                        </span>
                    <span class="logo-sm">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        <li class="menu-title">Menu</li>
                         ...
                         <li>
                            <a href="{{route('item.index')}}" class="waves-effect"><i class="icon-calendar"></i><span> Item </span></a>
                        </li>
                        <li>
                            <a href="{{route('invoice.index')}}" class="waves-effect"><i class="icon-accelerator"></i><span> Invoice </span></a>
                        </li>
                         <li>
                            <a href="{{route('category.index')}}" class="waves-effect"><i class="icon-spread"></i><span> Category </span></a>
                        </li>
                    <!--    <li>
                            <a href="#" class="waves-effect"><i class="icon-pencil-ruler"></i><span> Log Out </span></a>
                        </li> -->
                        <li>
                                        <a href="{{ route('logout') }}"
